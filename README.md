...
# Use `pyaes` for encryption and decryption using the AES algorithm

```

from pyaes import CryptoAES
...
# Use `pyaes` to safe credentials in encrypted form (and not plain text)
